...
anim_save("gardenharvest.gif")

```

```{r}
knitr::include_graphics("gardenharvest.gif")
```
...
anim_save("lisabiking.gif")

``` 
  
```{r}
knitr::include_graphics("lisabiking.gif")
```
...
```{r}
knitr::include_graphics("covidcasesbystate.gif")
```
...
```{r}
knitr::include_graphics("covid_cases_by_state_map.gif")
```
